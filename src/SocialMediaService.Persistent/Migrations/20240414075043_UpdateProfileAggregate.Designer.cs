...
namespace SocialMediaService.Persistent.Migrations
{
    ...
    [Migration("20240414075043_UpdateProfileAggregate")]
    partial class UpdateProfileAggregate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiscussionsTags", b =>
                {
            ...
            modelBuilder.Entity("SocialMediaService.Domain.Aggregates.Groups.Discussion", b =>
                {
            ...
            modelBuilder.Entity("SocialMediaService.Domain.Aggregates.Groups.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SocialMediaService.Domain.Aggregates.Profiles.FavoriteDiscussion", b =>
                {
                    b.Property<string>("ProfileId")
                        .HasColumnType("text");
                    ...
                    b.HasKey("ProfileId", "DiscussionId");

                    b.HasIndex("DiscussionId");

                    b.ToTable("FavoriteDiscussions");
                });
            ...
            modelBuilder.Entity("DiscussionsTags", b =>
                {
                    b.HasOne("SocialMediaService.Domain.Aggregates.Groups.Discussion", null)
                        .WithMany()
                        .HasForeignKey("DiscussionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SocialMediaService.Domain.Aggregates.Groups.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SocialMediaService.Domain.Aggregates.Posts.Comment", b =>
                {
                    b.HasOne("SocialMediaService.Domain.Aggregates.Groups.Discussion", "Discussion")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("SocialMediaService.Domain.Aggregates.Profiles.Profile", b =>
                {
                    ...
                    b.Navigation("FavoriteDiscussions");
